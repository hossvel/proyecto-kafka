...
public class CallbackLambdaProducer {

	public static final org.slf4j.Logger log = LoggerFactory.getLogger(CallbackLambdaProducer.class);
	...
	public static void main(String[] args) {
		...
		try(Producer<String, String>producer=new KafkaProducer<>(props);) {
			...
			for(int i= 0; i < 10000;i++) {
				...
				producer.send(new ProducerRecord<>("testtopicreplication3",String.valueOf(i),"Mensaje - " + (i + 1)), (metadata,exception) -> {
					if(exception!=null) {
